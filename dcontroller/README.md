...
[![godoc](https://pkg.go.dev/badge/github.com/l7mp/dbsp/dcontroller)](https://pkg.go.dev/github.com/l7mp/dbsp/dcontroller)
...
page](https://github.com/l7mp/dbsp/dcontroller/releases):

```console
# Linux amd64
curl -LO https://github.com/l7mp/dbsp/dcontroller/releases/download/v0.1.0/dcontroller_v0.1.0_Linux_x86_64.tar.gz
