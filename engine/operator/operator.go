...
const (
	...
	KindStamp              // Stamp: assign-once fields, snapshot form.
	KindStampIncremental   // StampIncremental: assign-once fields, delta form.
...
func (k Kind) String() string {
	...
	case KindStamp:
		return "stamp"
	case KindStampIncremental:
		return "stamp_incremental"
	case KindEquiJoin:
		return "equi_join"
	case KindEquiJoinH:
