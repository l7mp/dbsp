...
// lexMinExpr: marshals as {"@lexmin": [<args...>]}.
func (e *lexMinExpr) MarshalJSON() ([]byte, error) { return marshalVariadicOp("@lexmin", e.args) }
func (e *lexMinExpr) UnmarshalJSON(b []byte) error { return unmarshalInto(b, e) }

// lexMaxExpr: marshals as {"@lexmax": [<args...>]}.
func (e *lexMaxExpr) MarshalJSON() ([]byte, error) { return marshalVariadicOp("@lexmax", e.args) }
func (e *lexMaxExpr) UnmarshalJSON(b []byte) error { return unmarshalInto(b, e) }
